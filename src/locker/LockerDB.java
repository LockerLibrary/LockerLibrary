...
public class LockerDB {
    ...
    //     System.out.println(db.searchLocker("모리아관", 20).getLockerPk()); // 사물함 검색2 (건물명, 사물함 번호)

    //     // 추가
    //     db.addLocker("Mo-200", "모리아관", 200); // 사물함(Mo-300) 추가1 (pk, 건물명, 사물함)
    //     db.addLocker("모리아관", 300); // 사물함(Mo-200) 추가2 (건물명, 사물함)

    //     System.out.println(db.searchLocker("Mo-200").getLockerPk()); // 사물함(Mo-200) 추가여부 확인
    //     System.out.println(db.searchLocker("Mo-300").getLockerPk()); // 사물함(Mo-300) 추가여부 확인
